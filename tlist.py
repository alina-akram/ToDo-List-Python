...
last_id = 0 #outside the scope (this is in global scope)
...
class Todo(object):
    ...
    def __init__(self, todo_name, complete=False):
        ...
        global last_id # always use global when referencing var in global scope
        last_id += 1
        self.id = last_id
...
# also, i want you to write a “save” function that WRITES existing todos in your todo list to the Csv
   ...
   #accessing the class for the TodoList and assigning a variable to it
    while True:
        # READ
        user_input = input("Enter 1 to create a todo, 2 to remove a todo, 3 to complete a todo:")
